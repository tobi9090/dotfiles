...
theme.titlebar_minimize_button_normal =
	gears.surface.load_uncached(gfs.get_configuration_dir() .. "themes/night/minimize.svg")
...
theme.titlebar_maximized_button_normal_inactive =
	gears.surface.load_uncached(gfs.get_configuration_dir() .. "themes/night/maximized.svg")
...
theme.wallpaper = gears.surface.load_uncached(gfs.get_configuration_dir() .. "themes/night/882637.jpg")
